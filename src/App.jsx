...
import { CssBaseline, ThemeProvider, createTheme, alpha, lighten } from "@mui/material";
...
function App() {
  ...
  const backgroundColor = alpha(darkMode ? theme.palette.common.white : theme.palette.common.black, 0.15);
